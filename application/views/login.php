...
<head>
    ...
    <title>Sistem Pendukung Keputusan Pemilihan Peminatan Program Studi Desain Komunikasi Visual</title>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                    <div class="text-justify card-body p-0">
                        ...
                        <p>
                            Program Studi Teknik Informatika menyedian mata kuliah pilihan bagi mahasiswa pada semester
                            5. mata kuliah pilihan tersebut dapat dipilih berdasarkan minat mahasiswa yang dapat
                            digunakan sebagai penunjang tugas akhir mahasiswa
                        </p>
                    </div>
                </div>
            </div>
